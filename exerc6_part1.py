# -*- coding: utf-8 -*-
"""
Created on Sun Mar 15 16:37:46 2015
...
class Tree:
    ...
    def newick(self,node):
        ...
        return list1 # I couldn't manage to return a string... But the final structure of this list is similar to the one of a parenthetical tree
...
test = Tree()        
test.printNames(node=test.root)
test.treeLength(node=test.root)
test.newick(node=test.root) # Unfortunately this gives us a list and not a string...need to improve the function